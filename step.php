...
if (isset($_GET['steps-item'])){
  $step_id = $_GET['steps-item'];
  $step = $db->prepare('SELECT * FROM steps_items WHERE id=:id');
  $step->execute(['id'=>$step_id]);
  $step = $step->fetch();
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="content col-lg-9 col-md-9">
            <h1><?php echo $step['title']; ?></h1>
            <div class="img mt-3">
              <img src="upload/stepsitems/<?php echo $step['image'] ?>" alt="">
        

            </div><br>
            <div class="expl">
              <p class="pexpl center"> <?php echo $step['body']; ?> </p><br>
              <h6 class="h6expl">نویسنده : <?php echo $step['author']; ?></h6>
              <span class="spexpl"><?php echo $step['date']; ?></span>
            </div>
