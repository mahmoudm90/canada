...
if (isset($_POST['login'])) {
  if (trim($_POST['email'])!="" || trim($_POST['password'])!="") {
    ...
    header("Location:signin.php?err_msg=فیلدهای ایمیل و پسورد الزامی است");
    exit();
  }
}
 ?>
                ...
                <h3 class="text-white text-center pt-3">ورود</h2>
                    <div class="card-body" style="width: 400px">
                        <form method="post">
                            ...
                            <button type="submit" name="login" class="btn btn-outline-primary btn-block">ورود</button><br>
                            <div class="text-center">
                                <a href="register.php" class="">هنوز ثبت نام نکرده اید؟</a>
                            </div>
                        </form>
                    </div>
